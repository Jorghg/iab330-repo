...
+using Android.Views;
+using iRecover.MvvmCross.Binding.BindingContext;
+using iRecover.MvvmCross.Binding.Droid.BindingContext;
+using iRecover.MvvmCross.Droid.Views;
+using iRecover.MvvmCross.ViewModels;
+
